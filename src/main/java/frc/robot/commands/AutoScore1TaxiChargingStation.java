...
public class AutoScore1TaxiChargingStation extends SequentialCommandGroup {
  /** Creates a new AutoScore1TaxiChargingStation. */
  public AutoScore1TaxiChargingStation() {
